...
class ResNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.avgpool = nn.AvgPool2d(kernel_size=(4,4), stride=(1,1))#kernel=(4,4)
...
class visualFrontend(nn.Module):
    ...
    def forward(self, inputBatch):
        ...
        outputBatch = self.resnet(batch) #(64,512,2,2)
        outputBatch = outputBatch.reshape(batchsize, -1, 512) #(1,256,512), 
        outputBatch = outputBatch.transpose(1 ,2)#(1,512,256)
        outputBatch = outputBatch.transpose(1, 2).transpose(0, 1) #(256,1,512)
        return outputBatch
