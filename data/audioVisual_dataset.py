...
#         img_data=images[i]*255
#         img_data = img_data.astype(np.uint8)
#         img = Image.fromarray(img_data)
#         img.save(os.path.join(output_folder, f"image_{i+1}.png"))

#     print(f"111개의 이미지를 {output_folder} 폴더에 저장했습니다.")
# def save_frame(image_data,output_path):
...
#         mouthroi_A1, audio_A1 = get_mouthroi_audio_pair(mouthroi_A1, audio_A1, self.audio_window, self.num_frames, self.audio_sampling_rate) #(111,96,96)
#         mouthroi_B, audio_B = get_mouthroi_audio_pair(mouthroi_B, audio_B, self.audio_window, self.num_frames, self.audio_sampling_rate)
...
#             frame_A_list.append(frame_A)
#             frame_B_list.append(frame_B)
#         frames_A = torch.stack(frame_A_list).squeeze() #(3,224,224)
#         frames_B = torch.stack(frame_B_list).squeeze() 


#         #transform mouthrois and audios
#         mouthroi_A1 = self.lipreading_preprocessing_func(mouthroi_A1) #(64,112,112)
#         mouthroi_B = self.lipreading_preprocessing_func(mouthroi_B)#(64,88,88)
#         # save_images(mouthroi_A1,"mouthroi_A1")
#         # save_images(mouthroi_B,"mouthroi_B")
#         # save_frame(frames_A,"A.png")
#         # save_frame(frames_B,"B.png")
...
#         audio_spec_A1, audio_spec_B,audio_spec_mix1= self.spec_transform(audio_spec_A1),self.spec_transform(audio_spec_B), self.spec_transform(audio_spec_mix1)
