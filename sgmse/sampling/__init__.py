...
def get_pc_sampler(
	predictor_name, corrector_name, sde, score_fn, y,visual_embedding,
    ...
    def pc_sampler():
        ...
        with torch.no_grad():
            ...
            for i in tqdm(range(sde.N)):
                ...
                xt, xt_mean = corrector.update_fn(xt, vec_t, y=y, visual_embedding=visual_embedding,conditioning=conditioning)
                xt, xt_mean = predictor.update_fn(xt, vec_t, y=y, visual_embedding=visual_embedding,conditioning=conditioning)
