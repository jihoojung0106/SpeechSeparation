...
class LangevinCorrector(Corrector):
    ...
    def update_fn(self, x, t, y,visual_embedding,*args):
        target_snr = self.snr
        for _ in range(self.n_steps):
            grad = self.score_fn(x, t,y,visual_embedding)
...
class AnnealedLangevinDynamics(Corrector):
    ...
    def __init__(self, sde, score_fn, snr, n_steps):
        ...
        self.sde = sde
        self.score_fn = score_fn #Myscoremodel
        self.snr = snr
        self.n_steps = n_steps

    def update_fn(self, x, t, y,visual_embedding=None,*args):
        n_steps = self.n_steps #1
        target_snr = self.snr #0.5
        std = self.sde.marginal_prob(x, t, y)[1] #args:(1,64,256)
