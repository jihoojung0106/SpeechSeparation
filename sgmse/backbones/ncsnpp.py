...
class NCSNpp(nn.Module):
    ...
    def __init__(self, 
        ...
        **kwargs):
        ...
        self.conditional = conditional  # noise-conditional #False
        self.centered = centered
        self.scale_by_sigma = scale_by_sigma #False
        fir = fir
        ...
        self.input_channels = input_channels #discriminative면 2, 아니면 4
        self.spatial_channels = spatial_channels #1
    ...
    def forward(self, * , x, time_cond=None, visual_embedding=None):
        """
