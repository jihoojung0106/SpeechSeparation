...
for parser_ in (base_parser, parser):
	parser_.add_argument("--test_dir", type=str,default="test_dir", required=False, help="Directory containing your corrupted files to enhance.")
	parser_.add_argument("--enhanced_dir", type=str, default="enhanced_dir",required=False, help="Where to write your cleaned files.")
...
args.ckpt="/logs/storm/mode=regen-joint-training_sde=OUVESDE_score=ncsnpp_denoiser=ncsnpp_condition=both_data=wsj0_ch=1/version_15/checkpoints/last.ckpt"
