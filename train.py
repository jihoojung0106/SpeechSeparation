...
from sgmse.model import MyScoreModel, DiscriminativeModel, StochasticRegenerationModel
...
if __name__ == '__main__':
	...
	logger = TensorBoardLogger(save_dir=f"/logs/storm/", name=logging_name, flush_secs=30) if not args.nolog else None
